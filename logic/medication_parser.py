...
FORMS_MAP = {
    'TAB': 'TABLETA', 'TABLETA': 'TABLETA', 'TABLETAS': 'TABLETA', 'TBS': 'TABLETA', 'TABS': 'TABLETA',
    'CAP': 'CAPSULA', 'CAPSULA': 'CAPSULA', 'CAPSULAS': 'CAPSULA', 'CAPS': 'CAPSULA', 'CP': 'CAPSULA',
    'CAPSULA BLANDA': 'CAPSULA BLANDA', 'CAP BLANDA': 'CAPSULA BLANDA',
    'CAPSULA DURA': 'CAPSULA DURA', 'CAP DURA': 'CAPSULA DURA',
    'JBE': 'JARABE', 'JARABE': 'JARABE', 'JRB': 'JARABE', 'SYR': 'JARABE',
    'SUSP': 'SUSPENSION', 'SUSPENSION': 'SUSPENSION', 'SUS': 'SUSPENSION',
    'SOL': 'SOLUCION', 'SOLUCION': 'SOLUCION', 'SLN': 'SOLUCION', 'LIQ': 'SOLUCION',
    'INY': 'INYECTABLE', 'INYECTABLE': 'INYECTABLE', 'AMP': 'AMPOLLA', 'AMPOLLA': 'AMPOLLA', 'VIAL': 'VIAL',
    'UNG': 'UNGUENTO', 'UNGUENTO': 'UNGUENTO', 'POM': 'POMADA', 'POMADA': 'POMADA',
    'CRM': 'CREMA', 'CREMA': 'CREMA',
    'GEL': 'GEL',
    'GTS': 'GOTAS', 'GOTAS': 'GOTAS',
    'POLVO': 'POLVO', 'SOBRE': 'SOBRE', 'GRANULOS': 'GRANULOS',
    'AEROSOL': 'AEROSOL', 'INHALADOR': 'INHALADOR', 'SPRAY': 'SPRAY',
    'LOCION': 'LOCION'
}
